...
#NOVO
	...
	def retrieve_update(self, marker, desired_units=None, selected_fields=None, web_id_type=None, **kwargs):
		kwargs['_return_http_data_only'] = True
		if kwargs.get('callback'):
			return self.retrieve_update_with_http_info(marker, desired_units=None, selected_fields=None, web_id_type=None, **kwargs)
		else:
			(data) = self.retrieve_update_with_http_info(marker, desired_units=None, selected_fields=None, web_id_type=None, **kwargs)
			return data

	def retrieve_update_with_http_info(self, marker, desired_units=None, selected_fields=None, web_id_type=None, **kwargs):
